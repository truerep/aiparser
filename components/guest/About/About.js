          ...
          <div className="container">
            <div className="row align-center">
              ...
              <div className="col-lg-6 offset-xl-1" data-aos="fade-up-sm" data-aos-delay="100">
                <div className="text-center">
                  <img className="img-fluid d-inline-block" src="/images/screens/screen-4.png" alt="" />
                </div>
              </div>
            </div>
          ...
          <div className="container">
            ...
            <div className="video-popup-container position-relative" data-aos="fade-up-sm" data-aos-delay="50">
              <div className="ratio ratio-16x9 rounded-4 overflow-hidden mt-16">
                <img src="/images/thumbnails/video-thumb.jpg" alt="" className="img-fluid w-full h-full object-cover" />
              </div>
              <a className="video-play-btn bg-primary-dark text-dark" href="../../../../www.youtube.com/watch5a8f.html" data-vbtype="video" data-autoplay="true" data-maxwidth="1320px" data-overlay="rgba(23, 24, 37, 0.95)">
            ...
            <div className="row justify-center row-cols-1 row-cols-md-3 row-cols-xl-4 gy-10 gy-md-12 gy-lg-18">
              <div className="col" data-aos="fade-up-sm" data-aos-delay="50">
                <div className="team-card text-center">
                  <img src="/images/team/1.png" alt="" className="img-fluid team-member-img mb-6" />
              ...
              <div className="col" data-aos="fade-up-sm" data-aos-delay="100">
                <div className="team-card text-center">
                  <img src="/images/team/2.png" alt="" className="img-fluid team-member-img mb-6" />
              ...
              <div className="col" data-aos="fade-up-sm" data-aos-delay="150">
                <div className="team-card text-center">
                  <img src="/images/team/3.png" alt="" className="img-fluid team-member-img mb-6" />
              ...
              <div className="col" data-aos="fade-up-sm" data-aos-delay="200">
                <div className="team-card text-center">
                  <img src="/images/team/4.png" alt="" className="img-fluid team-member-img mb-6" />
              ...
              <div className="col" data-aos="fade-up-sm" data-aos-delay="50">
                <div className="team-card text-center">
                  <img src="/images/team/5.png" alt="" className="img-fluid team-member-img mb-6" />
              ...
              <div className="col" data-aos="fade-up-sm" data-aos-delay="100">
                <div className="team-card text-center">
                  <img src="/images/team/6.png" alt="" className="img-fluid team-member-img mb-6" />
              ...
              <div className="col" data-aos="fade-up-sm" data-aos-delay="150">
                <div className="team-card text-center">
                  <img src="/images/team/7.png" alt="" className="img-fluid team-member-img mb-6" />
              ...
              <div className="col" data-aos="fade-up-sm" data-aos-delay="200">
                <div className="team-card text-center">
                  <img src="/images/team/8.png" alt="" className="img-fluid team-member-img mb-6" />
                ...
                <div className="text-center">
                  ...
                  <div className="row align-center justify-center row-cols-3 row-cols-md-5 g-6 g-lg-10 g-xl-20">
                    <div className="col" data-aos="fade-up-sm" data-aos-delay="100" data-aos-offset="10">
                      <img src="/images/brands/1.png" alt="" className="img-fluid brand-img" />
                    </div>
                    <div className="col" data-aos="fade-up-sm" data-aos-delay="150" data-aos-offset="10">
                      <img src="/images/brands/2.png" alt="" className="img-fluid brand-img" />
                    </div>
                    <div className="col" data-aos="fade-up-sm" data-aos-delay="200" data-aos-offset="10">
                      <img src="/images/brands/3.png" alt="" className="img-fluid brand-img" />
                    </div>
                    <div className="col" data-aos="fade-up-sm" data-aos-delay="250" data-aos-offset="10">
                      <img src="/images/brands/4.png" alt="" className="img-fluid brand-img" />
                    </div>
                    <div className="col" data-aos="fade-up-sm" data-aos-delay="300" data-aos-offset="10">
                      <img src="/images/brands/5.png" alt="" className="img-fluid brand-img" />
                    </div>
                  </div>
                </div>
              </div>
